...
REAL_DATA = [
    ...
    # ── Population (INEGI Census — exact unless noted) ───────────────────
    # PVR's explosive growth mirrors Mexico's post-1970 tourism policy:
    # Fonatur designated PVR as a priority tourism destination in 1974.
    (1970, None, "population",  24155, "persons",
     "Total municipal population (exact)",
     "Población municipal total (exacto)",
     "INEGI IX Censo General de Población 1970"),
    (1980, None, "population",  57203, "persons",
     "Total municipal population (exact)",
     "Población municipal total (exacto)",
     "INEGI X Censo General de Población y Vivienda 1980"),
    (1990, None, "population", 111457, "persons",
     "Total municipal population (exact)",
     "Población municipal total (exacto)",
     "INEGI XI Censo General de Población y Vivienda 1990"),
    (1995, None, "population", 151896, "persons",
     "Total municipal population — Conteo de Población (exact)",
     "Población municipal total — Conteo de Población (exacto)",
    ...
    (2005, None, "population", 220368, "persons",
     "Total municipal population — II Conteo (exact)",
     "Población municipal total — II Conteo (exacto)",
    ...
    (2015, None, "population", 275640, "persons",
     "Total municipal population — Intercensal Survey (exact)",
     "Población municipal total — Encuesta Intercensal (exacto)",
