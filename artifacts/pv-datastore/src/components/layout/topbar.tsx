...
import logoDark from "@assets/vallartapulse_dark_T_1774385797873.png";
import logoLight from "@assets/vallartapulse_light_T_1774385797873.png";
...
export function Topbar({ onMenuClick }: { onMenuClick?: () => void }) {
  ...
  return (
    ...
    >
      {/* Logo — visible on all sizes; hamburger prepended on mobile */}
